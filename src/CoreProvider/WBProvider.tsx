...
export interface WBProviderProps {
    createServiceFactory: (dispatch: DispatchFunction, state: unknown, props: WBProviderProps) => unknown;
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    reducers: Reducer<any, Action<any, any>>[];
    initialState: unknown;
}

export function WBProvider(props: PropsWithChildren<WBProviderProps>) {
